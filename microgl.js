...
(function() {
  ...
  window.MicroGL = (function() {
    var TYPESIZE, TYPESUFFIX, glproto;
    ...
    function MicroGL(opt) {
      this._setTexture = __bind(this._setTexture, this);
    ...
    MicroGL.prototype._bindAttribute = function(attribute, value) {
      ...
      if (!this._useElementArray) {
        return this._numElements = value.length / size;
      }
    };

    MicroGL.prototype.bind = function(obj) {
      var attribute, name, uniform, value;
